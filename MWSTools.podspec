#
#  Be sure to run `pod spec lint WSTools.podspec' to ensure this is a
...
Pod::Spec.new do |s|
 ...
 # s.license      = "MIT (example)"
  ...
  s.author             = { "马文帅" => "mawenshuai100@163.com" }
  # Or just: s.author    = "马文帅"
  # s.authors            = { "马文帅" => "mawenshuai100@163.com" }
  # s.social_media_url   = "http://twitter.com/马文帅"
