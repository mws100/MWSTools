...
#import "UIDevice+MWSExtension.h"
...
@implementation UIDevice (MWSExtension)

+ (NSString *)mws_getMacAddressForAppWall {
    NSString *rawMac = [self mws_getMacAddress];
    return [[rawMac lowercaseString] stringByReplacingOccurrencesOfString:@":" withString:@""];
}
...
+ (NSString *)mws_getMacAddress {
    ...
    // Error...
    NSLog(@"getMacAddress Error: %@", errorFlag);
